...
var DefaultSignatureValidator = /** @class */ (function () {
    ...
    DefaultSignatureValidator.isValid = function (signature, secretKey, responseData) {
        ...
        var computedSignature = (0, crypto_1.createHmac)("sha256", secretKey !== null && secretKey !== void 0 ? secretKey : process.env.CHARGILY_APP_SECRET).update(responseData).digest("hex");
